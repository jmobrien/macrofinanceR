...
bvarwrap_tvA <-
  function(x, verbose=FALSE, dat = NULL, nLags = 2,
           lc_A0 = NULL, lc_lmd = NULL, lmdblock = NULL,
           breaks_pos = NULL, prior_params = NULL, n_cores = 1, dprior = TRUE,
    ...
    ## n_cores: deprecated option for using multicore processing in calculating the
    ...
    if (any(lmd < 0)){
      ...
      vout <- SVARhtskdmdd(dat, lags = nLags, xdata = NULL, const = TRUE, A0 = A,
                           ...
                           mn_start = prior_params$mn_start, train = 0, # cores = n_cores,
...
SVARhtskdmdd <-
  function(ydata,lags,xdata=NULL, const=TRUE, A0, lmd, breaks_pos, breaks=NULL,
...
###
  {
    ...
    vp <- varprior(nv,nx,lags,mn_prior,v_prior, ur_prior=ur_prior, ybar=ybar, mn_start = mn_start,cos_prior = cos_prior) # vp$: ydum,xdum,pbreaks
